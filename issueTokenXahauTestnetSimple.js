...
async function main() {
  ...
  if (cst_result.result.meta.TransactionResult == "tesSUCCESS") {
    console.log(
      `Transaction succeeded: https://test.xahauexplorer.com/explorer/${cst_signed.hash}`
    );
  } else {
  ...
  if (hst_result.result.meta.TransactionResult == "tesSUCCESS") {
    console.log(
      `Transaction succeeded: https://test.xahauexplorer.com/explorer/${hst_signed.hash}`
    );
  } else {
  ...
  if (ts_result.result.meta.TransactionResult == "tesSUCCESS") {
    console.log(
      `Transaction succeeded: https://test.xahauexplorer.com/explorer/${ts_signed.hash}`
    );
  } else {
  ...
  if (pay_result.result.meta.TransactionResult == "tesSUCCESS") {
    console.log(
      `Transaction succeeded: https://test.xahauexplorer.com/explorer/${pay_signed.hash}`
    );
  } else {
